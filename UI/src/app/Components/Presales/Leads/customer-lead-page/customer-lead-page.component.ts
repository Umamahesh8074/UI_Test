...
@Component({
  selector: 'app-customer-lead-page',
  templateUrl: './customer-lead-page.component.html',
  styleUrls: ['./customer-lead-page.component.css']
})
export class CustomerLeadPageComponent {
...
private overlayClass = 'customerpayment-overlay-class';
  ...
  goBack() {
    ...
    else if (this.user.roleName.toLocaleLowerCase()=="customer") {
