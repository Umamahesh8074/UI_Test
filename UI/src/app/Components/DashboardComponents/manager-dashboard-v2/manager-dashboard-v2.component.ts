...
@Component({
  selector: 'app-manager-dashboard-v2',
  templateUrl: './manager-dashboard-v2.component.html',
  styleUrls: ['./manager-dashboard-v2.component.css']
})
export class ManagerDashboardV2Component {
 ...
 saleMemberReport:any=[]
  ...
  panel4Expanded:boolean=false;
  panel5Expanded:boolean=false;
  constructor(
