...
@Component({
  selector: 'app-display-approved-purchase-order',
  templateUrl: './display-approved-purchase-order.component.html',
  styleUrls: ['./display-approved-purchase-order.component.css'],
})
export class DisplayApproveRejReworkPurchaseOrderComponent
