...
@Component({
  selector: 'app-app-rej-inventory-receivable',
  templateUrl: './app-rej-inventory-receivable.component.html',
  styleUrls: ['./app-rej-inventory-receivable.component.css'],
})
export class AppRejInventoryReceivableComponent
