...
@Component({
  selector: 'inventory-receivable-non-pending-approval',
  templateUrl: './inventory-receivable-non-pending-approval.component.html',
  styleUrls: ['./inventory-receivable-non-pending-approval.component.css'],
})
export class InventoryReceivableNonPendingApprovalComponent
  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    this.getNonPendingInventoryReceivables();
    this.fetchProjects();
    this.fetchVendors();
  }
  constructor(
