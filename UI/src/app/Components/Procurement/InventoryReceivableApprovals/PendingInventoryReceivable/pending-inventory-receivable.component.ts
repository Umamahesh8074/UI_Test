...
@Component({
  selector: 'app-pending-inventory-receivable',
  templateUrl: './pending-inventory-receivable.component.html',
  styleUrls: ['./pending-inventory-receivable.component.css'],
})
export class PendingInventoryReceivableComponent
