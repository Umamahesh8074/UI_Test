...
@Component({
  ...
  styleUrls: ['./indent-approval.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class DisplayIndentApprovalsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.fetchProjects();
    this.getApprOrRejOrReworkIndentsByUserId();
  }
