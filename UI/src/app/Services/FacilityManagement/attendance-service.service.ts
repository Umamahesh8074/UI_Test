...
export class AttendanceServiceService {
  ...
  //   return this.http.get<Page<Attendance>>`${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}`;
  // }
  ...
  fetchUser(page?: number, size?: number): Observable<Attendance[]> {
    return this.http.get<Attendance[]>(
      `${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}/getallAttendance?page=${page}&size=${size}`
    );
  }
  ...
  addAttendance(attendance: Attendance): Observable<Attendance> {
    ...
    return this.http.post<Attendance>(
      `${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}/save`,
      attendance
    );
  }
  ...
  deleteAttendance(id: number): Observable<string> {
    ...
    return this.http
      .delete<string>(
        `${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}/${id}`
      )
      .pipe(
        tap(() => {
  ...
  updateAttendance(attendance: any): Observable<any> {
    ...
    return this.http.put<any>(
      `${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}/update`,
      attendance
    );
  }
  ...
  getAllAttendance(
    ...
    return this.http.get<Page<AttendanceDto>>(
      `${environment.facilitymanagementBaseUrl}${ControllerPaths.ATTENDANCE}/allAttendance?userName=${userName}&userId=${userId}&page=${page}&size=${size}&range=${rangeOfDays}&startDate=${startDate}&endDate=${endDate}&attendanceStatus=${status}&shiftIds=${shiftIds}&locationId=${locationId}&roleId=${roleId}&isExportExcel=${isExportExcel}`,
  ...
  getAttendanceReport(
    ...
    return this.http.get<Page<AttendanceReportDto[]>>(
      `${environment.facilitymanagementBaseUrl}${ControllerPaths.ATTENDANCE}/allReport?userId=${userId}&locationId=${selectlocationId}&roleId=${roleId}&page=${page}&pageSize=${pageSize}&userName=${userName}&range=${rangeOfDays}&startDate=${startDate}&endDate=${endDate}`
    );
  }
  ...
  getPresent(
    ...
    return this.http.get<AttendanceCountDto[]>(
      `${environment.facilitymanagementBaseUrl}${ControllerPaths.ATTENDANCE}/dashboard/attendance/data?userId=${userId}&organizationId=${organizationId}&range=${rangeOfDays}&startDate=${customStartDate}&endDate=${customEndDate}&shiftIds=${shiftIds}&locationId=${locationId}`
    );
  }
  ...
  getMyAttendanceReport(
    ...
    if (endDate == undefined) endDate = '';
    return this.http.get<Page<AttendanceReportDto[]>>(
      `${environment.facilitymanagementBaseUrl}/${ControllerPaths.ATTENDANCE}/myattendancereport?userId=${userId}&page=${page}&pageSize=${pageSize}&range=${rangeOfDays}&startDate=${startDate}&endDate=${endDate}`
    );
  }
